 ...
 */
package org.solent.test.project.dao.jaxbimpl;
...
import org.solent.test.project.model.EntityList;
...
public class EntityDAOJaxbImpl implements EntityDAO {
    ...
    private static final String CONTEXT_PATH = "org.solent.test.project.model";
